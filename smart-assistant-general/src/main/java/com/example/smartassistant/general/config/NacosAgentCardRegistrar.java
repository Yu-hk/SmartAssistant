...
/**
 * 应用启动时将 General Agent (GeneralChat) 注册到 Nacos A2A Registry。
 *
 * @see com.example.smartassistant.general.config.NacosAgentCardConfig
 */
@Component
...
public class NacosAgentCardRegistrar implements ApplicationRunner {
    ...
    public NacosAgentCardRegistrar(AiService aiService, AgentCard agentCard,
                                   @Value("${server.port:8087}") int serverPort) {
