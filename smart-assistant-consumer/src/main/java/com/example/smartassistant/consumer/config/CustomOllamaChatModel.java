...
/**
 * 自定义 Ollama ChatModel — @Primary 默认推理通道（Consumer 模块）
 * <p>
 * 实现 Spring AI 的 {@link ChatModel} 接口，
 * 通过 {@link OllamaApiClient} 调用本地 Ollama API。
 * 作为 SmartAssistant 的主要推理引擎。
 */
...
public class CustomOllamaChatModel implements ChatModel {
    ...
    public CustomOllamaChatModel(
        ...
        log.info("[CustomOllama] Consumer initialized (model={}, baseUrl={}, temperature={})", model, baseUrl, temperature);
    }
