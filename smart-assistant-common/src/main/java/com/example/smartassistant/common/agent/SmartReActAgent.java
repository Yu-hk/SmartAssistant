            ...
            if (answerText != null && !answerText.isBlank()) {
                ...
                if (!guardResult.isContinue()) {
                    ...
                    return switch (guardResult.action()) {
                        ...
                        // Stop before any further tool execution, but preserve both the
                        // verified facts and the actual confirmation question for the user.
                        case AWAIT_CONFIRMATION -> answerText;
