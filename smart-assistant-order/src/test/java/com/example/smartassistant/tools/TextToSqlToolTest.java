...
class TextToSqlToolTest {
    ...
    @Test
    @DisplayName("textToSql should return error when model API call fails")
    void should_returnError_when_modelApiUnavailable() {
        ...
        assertTrue(result.contains("SQL 生成失败"),
                "Should return an error message when the model API is unreachable");
    }
