...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidationException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_001", msg, null, getTraceId());
    ...
    public ResponseEntity<ApiResponse<Void>> handleIllegalArgument(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_001", e.getMessage(), null, getTraceId());
        return ResponseEntity.badRequest().body(
    ...
    public ResponseEntity<ApiResponse<Void>> handleGraphStateException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_003", truncate(e.getMessage(), 300), null, getTraceId());
    ...
    public ResponseEntity<ApiResponse<Void>> handleDataAccessException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_004", truncate(e.getMessage(), 200), null, getTraceId());
    ...
    public ResponseEntity<ApiResponse<Void>> handleResourceAccessException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_004", e.getMessage(), null, getTraceId());
    ...
    public ResponseEntity<ApiResponse<Void>> handleSecurityException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_005", msg, null, getTraceId());
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneralException(
        ...
        ApiResponse.ErrorDetail error = new ApiResponse.ErrorDetail(
                "TRAVEL_099", e.getClass().getSimpleName() + ": " + e.getMessage(), null, getTraceId());
        return ResponseEntity.internalServerError().body(
