...
public class AgentChatController {
    ...
    public AgentChatController(@Qualifier("orderAgent") SmartReActAgent orderAgent,
    ...
    public ResponseEntity<AgentApiResponse<AgentChatResponse>> chat(@RequestBody AgentChatRequest request) {
        ...
        try {
            String responseText = orderAgent.execute(request.message());
            ...
            return ResponseEntity.ok(AgentApiResponses.ok(
                    data, "order_agent", request.requestId(), elapsed));
