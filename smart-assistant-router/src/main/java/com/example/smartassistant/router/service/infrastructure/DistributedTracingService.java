package com.example.smartassistant.router.service.infrastructure;
...
/**
 * 分布式追踪服务（Router Service）
 * 基于 Slf4j MDC 实现轻量级追踪，与 Consumer 端保持一致
 */
@Component
public class DistributedTracingService {
    ...
    /**
     * 开始追踪上下文（从 Consumer 传递的 requestId）
     */
    public void startTrace(String requestId, String threadId) {  // ⭐
        ...
        // 设置 Span ID（Router 的新 Span）
        String spanId = generateSpanId();
        MDC.put(SPAN_ID_KEY, spanId);
        
        // 设置 Request ID（从 Consumer 传递）
        ...
        log.debug("[Tracing] Router 开始追踪: traceId={}, spanId={}, requestId={}, threadId={}", 
    ...
    public void endTrace() {
        ...
        log.debug("[Tracing] Router 结束追踪: traceId={}, spanId={}, requestId={}, threadId={}", 
            traceId, spanId, requestId, threadId);
