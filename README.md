...
| 模型 | **DeepSeek V4-Flash**（通用/订单/商品 Agent 主通道）+ **Ollama 本地推理**（qwen2.5:7b Router 路由 + qwen2.5:3b 轻量任务） + BGE-large-zh ONNX (1024d RAG/知识库) / BGE-small-zh ONNX (512d Cache) / bge-reranker-v2-m3 ONNX (重排序) | — |
...
├── monitoring/    RouterMetricsCollector
...
| **总计** | **296+** | **46 个 P0-P4 基准测试，0 Failures** |
