...
package com.example.smartassistant.toolregistry.tool.common;
...
/**
 * Data GIF generation tool — renders time-series data as animated GIF.
 * <p>Pure Java implementation with XChart and ImageIO, no external rendering dependencies.</p>
 */
@Component
public class DataGifTool implements RegistryTool {
    ...
    private final GifCacheStore gifCacheStore;

    public DataGifTool(ToolRegistry toolRegistry, ToolRegistryClient registryClient,
    ...
    public byte[] getGifFromCache(String cacheKey) {
        byte[] data = gifCacheStore.consume(cacheKey);
        if (data == null) {
    ...
    public java.util.Map<String, byte[]> getAllCacheEntries() {
        return gifCacheStore.getAll();
    }
    ...
    public String generateTrendGif(
        ...
        try {
            ...
            gifCacheStore.put(cacheKey, gifData);
