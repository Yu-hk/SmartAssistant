...
public class CustomDeepSeekChatModel implements ChatModel {
    ...
    public CustomDeepSeekChatModel(
        ...
        log.info("[CustomDeepSeek] initialized (temperature={}, maxTokens={})", temperature, maxTokens);
    }

    @Override public ChatResponse call(Prompt prompt) {
        try {
            String requestJson = apiClient.buildRequestJson("deepseek-v4-flash", temperature, maxTokens, buildMessages(prompt), null);
