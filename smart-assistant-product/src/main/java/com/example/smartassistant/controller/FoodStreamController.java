...
import com.example.smartassistant.service.agent.StreamingFoodAgentService;
...
@Slf4j
public class FoodStreamController {

    private final StreamingFoodAgentService streamingAgentService;

    public FoodStreamController(StreamingFoodAgentService streamingAgentService) {
